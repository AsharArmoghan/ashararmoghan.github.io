import codeBlog1 from "@/public/assets/images/codeblog/codeblog1.png";
import codeBlog2 from "@/public/assets/images/codeblog/codeblog2.png";
import codeBlog3 from "@/public/assets/images/codeblog/codeblog3.png";
...
import portfolioImg1 from "@/public/assets/images/portfolio/Portfolio1.png";
import portfolioImg2 from "@/public/assets/images/portfolio/Portfolio2.png";
import portfolioImg3 from "@/public/assets/images/portfolio/Portfolio3.png";
import portfolioImg4 from "@/public/assets/images/portfolio/Portfolio4.png";
import portfolioImg5 from "@/public/assets/images/portfolio/Portfolio5.png";
import { ProjectData } from "../../Types/ProjectDetailsTypes";

export const projectDescriptions: ProjectData[] = [
  {
    id: 1,
    title: "Code Blog",
    fullTitle: "Code Blog - Full-Stack Blogging Platform",
    slug: "code-blog",
    ...
    introduction:
      "Code Blog was built to address the lack of developer-focused features in existing platforms. The goal was to create a polished, professional space where junior developers can showcase expertise and build an audience, while demonstrating production-ready full-stack capabilities.",
    purposeAndGoal:
      "Designed to fill the gap for code-centric sharing platforms. Starting from user flow sketches (Auth → Write → Publish), the project prioritized a robust schema and API design. Angular was chosen for its strong dependency injection, while Node.js provided a scalable, lightweight backend.",
    images: [
      { imgSrc: codeBlog1.src, width: 1440, height: 1000 },
      { imgSrc: codeBlog2.src, width: 1440, height: 1000 },
      { imgSrc: codeBlog3.src, width: 1440, height: 1000 },
    ],
    icons: [
      {
        name: "Angular",
    ...
    currentStatus:
      "Deployed on Vercel (Front) and Render (Back). Actively used by a network of developer peers. Continuous updates focus on performance optimization and handling edge cases discovered through real-world usage.",
    technicalLessons: [
  ...
  },
  {
    ...
    fullTitle: "React Sales Dashboard - Analytics Platform",
    ...
    introduction:
      "Built to replace gut-feeling decisions with data. The goal: empower teams with clear visibility into performance metrics and meaningful visualizations, while demonstrating complex React state management at scale.",
    purposeAndGoal:
      "modeled after leaders like Stripe and Shopify. The focus was efficient data serving using API aggregation rather than client-side computation and using React Context for clean, maintainable state management without Redux bloat.",
    images: [
      { imgSrc: dImage1.src, width: 1440, height: 1000 },
      { imgSrc: dImage2.src, width: 1440, height: 1000 },
    ],
    icons: [
      {
        name: "React",
    ...
    approach: {
      overview: "Built with React hooks and Context API for state management.",
      points: [
        {
          label: "Frontend",
          description:
    ...
    currentStatus:
      'Deployed and functional with real-world data handling. The architecture is business-ready, with visualizations continuously refined based on "stakeholder" (simulated business requirements) feedback.',
    technicalLessons: [
    ...
    impact:
      "Influenced all future React work: confident state persistence, cleaner API communication, and a new appreciation for the precision required in building analytical tools.",
    installation:
  ...
  },
  {
    id: 3,
    title: "Portfolio",
    fullTitle: "Next.js Portfolio - Modern Web Developer Showcase",
    slug: "portfolio",
    ...
    description:
      "A personal portfolio built using Next.js 15 (App Router) with Server-Side Rendering (SSR), dynamic routing, and MVC architecture, designed to showcase projects, skills, and experience. The portfolio demonstrates the ability to build SEO-optimized, high-performance web applications with modern best practices, serving both as a marketing tool to land interviews and a technical showcase of development abilities.",
    introduction:
      "More than a showcase—it's a technical demonstration of Next.js mastery. Built to impress technical evaluators with fast navigation, perfect SEO scores, and clean MVC-like architecture.",
    purposeAndGoal:
      "Designed for performance and scalability. leveraged Next.js App Router for dynamic project/[slug] routes, automated metadata generation, and React Server Components to minimize client-side javascript.",
    images: [
      { imgSrc: portfolioImg1.src, width: 1440, height: 1000 },
      { imgSrc: portfolioImg2.src, width: 1440, height: 1000 },
    ],
    icons: [
      {
        name: "NextJs",
    ...
    approach: {
      ...
      points: [
        ...
        { label: "Images", description: "Image optimization with next/image" },
        {
          label: "Styling",
    ...
    challenges: [
      {
        challenge: "Managing SSR with dynamic content while keeping pages fast",
        solution:
    ...
    currentStatus:
      "Live, actively maintained, and evolving. Serves as both a marketing tool and a testing ground for new Next.js features.",
    technicalLessons: [
    ...
    impact:
      "Set the template for all my future web projects: think SEO/Performance first, use TypeScript, and maintain strict MVC-like separation in folder structures.",
    installation: "cd portfolio && npm install && npm run dev",
  },
];
export const projectSummary = {
  intro:
    "These three projects represent the breadth of capabilities as a full-stack developer:",
  conclusion:
    "Together, these three projects tell the story of a developer who can take projects from concept to production, handle both frontend and backend challenges, and continuously learn and improve. This is exactly what employers are looking for.",
};
