...
const Footer = () => {
  return (
    <footer className="fixed bottom-0 z-0 h-auto w-full overflow-hidden bg-stone-500 text-stone-200 dark:bg-stone-800 md:h-[380px]">
      <ParticleEffect
        grain={{
          opacity: 0.5,
          baseFrequency: 0.5,
      ...
      <div className="relative z-10 flex h-full flex-col justify-between px-6 pt-6 md:px-12 lg:px-24">
        <div className="grid grid-cols-2 gap-6 md:grid-cols-12 md:gap-4">
          <div className="col-span-2 flex flex-col gap-4 md:col-span-5 md:gap-6">
            <div className="origin-top-left scale-90 md:scale-100">
              <div className="flex items-center gap-2">
                <Logo
                  color="fill-white"
                  className="relative z-10 mr-3 h-8 w-8 md:h-12 md:w-12"
                />
            ...
            <p className="prose-md prose max-w-md text-sm leading-normal text-stone-200 antialiased md:text-base">
            ...
            <div className="mt-2 flex flex-col gap-2 md:mt-4">
              ...
              <ul className="flex flex-col gap-2 text-sm leading-relaxed text-stone-200 md:text-base">
          ...
          <div className="z-20 col-span-1 flex flex-col gap-4 md:col-span-2 md:col-start-8">
            <h3 className="text-sm font-semibold uppercase leading-relaxed tracking-widest text-white/90 antialiased grayscale md:text-xl">
              Navigation
            </h3>
              ...
              {NAV_SECTIONS.map((section) => (
                ...
                >
                  <Link
                    ...
                    className="group flex items-center gap-2 text-sm leading-relaxed text-stone-200 antialiased transition-colors hover:text-white md:text-base"
                  >
          ...
          <div className="z-2 col-span-1 flex flex-col gap-4 md:col-span-2 md:col-start-11">
            <h3 className="text-sm font-semibold uppercase tracking-widest text-white/90 antialiased grayscale md:text-xl">
              Socials
            </h3>
            <ul className="flex flex-col gap-2 text-sm leading-relaxed text-stone-200 antialiased md:gap-4 md:text-base">
        ...
        <div className="mt-2 flex flex-col items-center justify-between gap-2 border-t border-white/10 pb-2 pt-4 text-[10px] text-stone-200 md:flex-row md:text-xs">
